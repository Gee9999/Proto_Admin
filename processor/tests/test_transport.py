...
def test_pull_worker_reports_staged_result_and_metrics(tmp_path: Path) -> None:
    ...
    assert adapter.completed["quality"]["pipeline_version"] == "proto-image-v1"
    ...
    def fake_request(path, payload):
        ...
        if payload["action"] == "claim":
            return {
                ...
                "processing": {"remove_background": True, "background": "white", "width": 1600, "height": 1600, "output_format": "jpeg"},
            }
        return {"ok": True}
