...
class PullWorker:
    ...
    def process_one(self) -> bool:
        ...
        try:
            ...
            self.adapter.complete(job, {"status": "completed", "processor_job_id": local["id"], "result": {"sha256": output_sha256, "bytes": len(output), "content_type": local["output_content_type"], "filename": output_path.name}, "quality": local["metrics"], "warnings": local["warnings"], "processing_ms": 0})
